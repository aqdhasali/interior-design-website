export default function ThirdContainer(){
    return(
        <div className="min-h-screen flex flex-col mt-20 m-10 gap-20">
            ...
            <div className="flex flex-col gap-5 lg:flex-row justify-center items-center ">
                ...
                <div  className="text-justify"> 
                    <h1  className="lg:text-right text-4xl font-bold">Designed by the finest designers.</h1>
                    <p className="lg:text-right italic mt-5"> Our interiors are a testament to creativity, elegance, and attention to detail. Every space we create reflects a perfect blend of functionality and aesthetics, tailored to your unique vision and lifestyle. </p>
                </div>
            </div>
